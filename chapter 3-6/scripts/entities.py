...
BASE_PATH = 'chapter 3-6/graphics'

class Player:
    def __init__(self,game):
        self.game = game
        self.image = pygame.image.load('chapter 3-6/graphics/Player/player_walk_1.png')
    ...
    def update(self,x_movement):
        ...
        for enemy in self.game.enemy_list:
            if self.rect.colliderect(enemy.rect):
                self.game.enemy_list.remove(enemy.rect)
                self.game.points+=1
...
class Enemy:
    def __init__(self,game):
        self.game = game
        self.image = pygame.image.load('chapter 3-6/graphics/snail/snail1.png')
        self.image = pygame.transform.scale_by(self.image,2)
    ...
    def update(self):
        ...
        if self.rect.right < 0:
            return True # Indicate that this enemy should be removed
